...
Function:实盘开户性别选择女性，勾选完善资料，填写固定电话
@author: lina
...
class TestOpenShipan(unittest.TestCase):
    def setUp(self):
        ...
        self.base_url = "http://mall.jsdyyt.com/"
    ...
    def test_open_shipan(self):
        ...
        sleep(3)
        pub_shipan_accountinfo.Pub(self.dr).open_account_with_phone(json_data["nickname"],json_data['province'],json_data['city'],
                                                           json_data['region'],json_data['address'],json_data['phone'],
