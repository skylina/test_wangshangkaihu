...
class TestRegister(unittest.TestCase):
    ...
    def test_register(self):
        ...
        self.register_.register(json_data["email"], json_data["memberno"], json_data["mobileno"], json_data["imgCheckCode"], json_data["checkCode"], json_data["recommender"], "register")   
