...
Function:实盘开户性别选择女性，勾选完善资料，填写固定电话和邮编
@author: lina
...
class TestOpenShipan(unittest.TestCase):
    ...
    def test_open_shipan(self):   
        ...
        sleep(3)
        save_file_path="trade_userinfo"
        pub_shipan_accountinfo.Pub(self.dr).open_account_m(json_data["nickname"],json_data['province'],json_data['city'],json_data['region'],json_data['address'],json_data['phone'],json_data['post_id'],json_data['memberno'],json_data['referrer'],json_data['pic1'],json_data['pic2'],json_data['pic3'],json_data['edit_password'],save_file_path)
