...
Function:实盘开户性别选择男性，勾选完善资料，不填写固定电话和邮编
@author: lina
...
class TestOpenShipan(unittest.TestCase):
    ...
    def test_open_shipan(self):
        ...
        sleep(3)
        pub_shipan_accountinfo.Pub(self.dr).open_account_with_click_gouxuanbtn(json_data["nickname"],json_data['province'],json_data['city'],
                                                           json_data['region'],json_data['address'],json_data['memberno'],json_data['referrer'],
