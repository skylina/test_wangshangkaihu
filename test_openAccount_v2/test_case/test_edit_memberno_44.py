...
Function:点击个人信息 会员单位  填写完个人信息、协议签署、上传照片未点击下一步之后进行更换会员
在首页->个人信息->会员单位 进行-》会员变更
@author: lina
...
class TestAccountInfo(unittest.TestCase):
    ...
    def with_account_info(self):
        ...
        self.pub_.userinfo_change_memberNo_after_upload_photo_without_next(nickname, province, city, region, 
        ...
        #self.dr.find_element_by_xpath("//input[@id='changeOpen' and @style='cursor:pointer']")
