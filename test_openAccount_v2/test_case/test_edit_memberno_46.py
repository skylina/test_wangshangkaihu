...
Function:会员变更  点击个人信息 会员单位  填写完个人信息、协议签署点击下一步之后
个人信息-》协议管理
@author: lina
...
class TestAccountInfo(unittest.TestCase):
    ...
    def with_account_info(self):
        ...
        self.pub_.userinfo_change_memberNo_after_input_protocol_with_next(nickname, province, city, region, 
                                                       address, phoneno, postId,member, referrer)
