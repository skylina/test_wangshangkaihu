...
Function:实盘开户OK之后进行更换会员
在首页->个人信息->会员单位 进行-》会员变更  验证会员名称以及ID并且变更按钮disable
@author: lina
...
class TestAccountInfo(unittest.TestCase):
    ...
    def with_account_info(self):
        ...
        self.pub_.change_memberNo_after_upload_photo_with_next(nickname, province, city, region, 
        ...
        msg=self.dr.find_element_by_id("changeOpen").get_attribute("disable")
        print msg 
        self.assertTrue("disable", msg)
