...
class Test_all(unittest.TestCase):
    ...
    def test_all(self):
        ...
        '''
        cardID_path=path.join(path.dirname(path.dirname(path.abspath(__file__))), "test_data\\data_cardID.json")
        pub_shipan_accountinfo.Pub(self.dr).open_account_m(json_data["nickname"],cardID_path,json_data['province'],
