...
Function:测试修改邮件使用手机进行验证，在原邮箱中打开验证邮件点击URL，
输入新邮箱之后，打开新邮箱收到的激活邮件中的 激活字段
@author: lina
...
class TestAccountInfo(unittest.TestCase):
    ...
    def test_edit_email_m(self):
        ...
        self.editE.edit_email_user_mobile(json_data['code'])
        ...
        ac=active_page.ActiveEmailPage(self.dr)
        ac.get_active_with_word(emailUsername, emailPwd)
