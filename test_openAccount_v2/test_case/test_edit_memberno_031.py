...
class TestAccountInfo(unittest.TestCase):
    ...
    def with_account_info(self):
        ...
        self.pub_.by_link_text(u"会员单位").click()
        pub = pub_shipan_accountinfo.Pub(self.dr)
        mem_name = pub.get_member_name()
        mem_id = pub.get_member_id()
        self.assertTrue("江苏大泰贵金属有限公司", mem_name)
        self.assertTrue("129", mem_id)
        '''
        text_ = u"协议签署"
